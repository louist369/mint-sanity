...
Share a lookup with `?mint=` on the URL (for example [WSOL](https://louist369.github.io/mint-sanity/?mint=So11111111111111111111111111111111111111112)). A valid mint in the query string runs the lookup on load; after any lookup the address is written back with `history.replaceState`.
